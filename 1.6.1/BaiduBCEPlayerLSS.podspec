Pod::Spec.new do |s|
  ...
  s.source   =   { :http => 'http://sdk.bce.baidu.com/media-sdk/Baidu-T5Player-SDK-iOS-LSS-1.6.1.zip?responseContentDisposition=attachment',:sha1 => "3f1f5f239cd1bf0f3640ce0084d664d3b938d183"}
