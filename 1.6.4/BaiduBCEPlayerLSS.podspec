Pod::Spec.new do |s|
  ...
  s.source   =   { :http => 'http://sdk.bce.baidu.com/media-sdk/Baidu-T5Player-SDK-iOS-LSS-1.6.4.zip?responseContentDisposition=attachment',:sha1 => "775e02570d0b0bc46fc1495e811907c79ecbcffd"}
